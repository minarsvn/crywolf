...
- I ported over my personal site from [Hugo](/blog/migrating-to-hugo) to [Next.js + MDX](https://github.com/leerob/crywolf.me).
...
My [portfolio](https://github.com/leerob/crywolf.me) has transformed quite a bit since I started it in 2014. Originally, it was
...
hosted on a domain so fast. I was even able to setup email forwarding for my domain and create `me@crywolf.me` using [improvmx](https://improvmx.com/) 🎉
