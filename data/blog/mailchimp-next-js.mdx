...
If you'd like to see a completed example, the entire source code for my blog is [open source](https://github.com/leerob/crywolf.me/blob/bfbd33a822fbcbbafd4027aa45884446f6f8ff3c/pages/api/subscribe.js).
