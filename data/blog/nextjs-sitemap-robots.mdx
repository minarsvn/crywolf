...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
      <loc>https://crywolf.me</loc>
  </url>
  <url>
      <loc>https://crywolf.me/blog</loc>
  </url>
</urlset>
```
...
> **Note:** `globby` [might not work](https://github.com/leerob/crywolf.me/issues/293) on Windows.
...
```bash
User-agent: *
Sitemap: https://crywolf.me/sitemap.xml
```
